...
# ------------------------------------------------------------------------------
"""
The misclib package contains a number of modules containing classes 
and functions of a more general nature, such as classes for handling 
data structures, functions for checking and handling lists, numbers 
and errors, I/O etc. 
"""
# ------------------------------------------------------------------------------

__all__ = ['deque',     'errwarn', 'heap',    'inandout', 'iterables', \
           'mathconst', 'matrix',  'numbers', 'stack']
