...
# -----------------------------------------------------------------------------
"""
The machdep package consists entirely of a file with a set of 
constants which should be checked and possibly changed on each new 
machine on which SimElements is implemented. 
"""
# -----------------------------------------------------------------------------
